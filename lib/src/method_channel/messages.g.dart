...
class MapViewApi {
  ...
  Future<UserInterfaceStyleDto?> getOverrideUserInterfaceStyle(
    int viewId,
  ) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getOverrideUserInterfaceStyle$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as UserInterfaceStyleDto?);
    }
  }

  Future<void> setOverrideUserInterfaceStyle(
    int viewId,
    UserInterfaceStyleDto? style,
  ) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setOverrideUserInterfaceStyle$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
