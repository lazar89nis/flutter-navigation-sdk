...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(131);
      writeValue(buffer, value.index);
    } else if (value is UserInterfaceStyleDto) {
      buffer.putUint8(132);
      writeValue(buffer, value.index);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 132:
        final int? value = readValue(buffer) as int?;
        return value == null ? null : UserInterfaceStyleDto.values[value];
      case 133:
        final int? value = readValue(buffer) as int?;
...
abstract class TestMapViewApi {
  ...
  static void setUp(
    ...
    }
    {
      final BasicMessageChannel<Object?>
      pigeonVar_channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getOverrideUserInterfaceStyle$messageChannelSuffix',
        pigeonChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(pigeonVar_channel, (
              ...
              assert(
                message != null,
                'Argument for dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getOverrideUserInterfaceStyle was null.',
              );
              final List<Object?> args = (message as List<Object?>?)!;
              final int? arg_viewId = (args[0] as int?);
              assert(
                arg_viewId != null,
                'Argument for dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getOverrideUserInterfaceStyle was null, expected non-null int.',
              );
              try {
                final UserInterfaceStyleDto? output = api
                    .getOverrideUserInterfaceStyle(arg_viewId!);
                return <Object?>[output];
              } on PlatformException catch (e) {
                return wrapResponse(error: e);
              } catch (e) {
    ...
    }
    {
      final BasicMessageChannel<Object?>
      pigeonVar_channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setOverrideUserInterfaceStyle$messageChannelSuffix',
        pigeonChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(pigeonVar_channel, (
              ...
              assert(
                message != null,
                'Argument for dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setOverrideUserInterfaceStyle was null.',
              );
              final List<Object?> args = (message as List<Object?>?)!;
              final int? arg_viewId = (args[0] as int?);
              assert(
                arg_viewId != null,
                'Argument for dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setOverrideUserInterfaceStyle was null, expected non-null int.',
              );
              final UserInterfaceStyleDto? arg_style =
                  (args[1] as UserInterfaceStyleDto?);
              try {
                api.setOverrideUserInterfaceStyle(arg_viewId!, arg_style);
                return wrapResponse(empty: true);
              } on PlatformException catch (e) {
                return wrapResponse(error: e);
              } catch (e) {
